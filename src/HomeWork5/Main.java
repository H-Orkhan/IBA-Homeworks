...
public class Main {
    public static void main(String[] args) {
        ...
        Pet pet = new Pet("Rax","Dog",5,75, new String[]{"eat", "sleep", "play"});
        ...
        Pet pet1 = new Pet("Dog", "Rax", 5, 75, new String[]{"eat", "sleep", "play"});
        Pet pet2 = new Pet("Dog" ,"Rax", 5, 75, new String[]{"eat", "sleep", "play"});
